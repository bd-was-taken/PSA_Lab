...
V_mag = abs(V); % Voltage magnitude
V_ang = rad2deg(angle(V)); % Voltage angle in degrees


% Display magnitude and angle separately
disp('Voltage Magnitudes (in pu):');
disp(V_mag);

disp('Voltage Angles (in degrees):');
disp(V_ang);
